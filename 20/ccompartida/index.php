<?php  
	...
	$titu = 'DTIC-Compartida'; 
	
	$desc = 'Carpeta de archivos compartidos por DTIC.';
	
	$dest = 'https://drive.google.com/drive/folders/1lzYHy5-lq37HIcP0R56fPL3sGhQN4m88?usp=sharing';

	$imag = rmMyURL() . 'compartida.jpg';
