<?php  
	...
	$titu = 'Solicitar Evento o Equipo - DTIC UTNLaRioja.'; 
	
	$desc = 'Formulario de solicitud de equipos para eventos.';
	
	$imag = rmMyURL() . 'minia.png';
	
	$time = 0.5;
	
	$dest = 'https://forms.gle/Lu5wCQKbVT9PGjye7';
	// $dest = 'https://forms.gle/9ynmNJKVNVTbZwcX9';
